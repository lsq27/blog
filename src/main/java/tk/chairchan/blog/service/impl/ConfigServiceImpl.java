...
import tk.chairchan.blog.dao.BlogConfigMapper;
import tk.chairchan.blog.entity.BlogConfig;
import tk.chairchan.blog.service.ConfigService;
...
public class ConfigServiceImpl implements ConfigService {
    public static final String websiteName = "chairchan blog";
    ...
    public static final String yourEmail = "xxx@mail.com";
    public static final String yourName = "name";
    public static final String footerAbout = "have fun.";
    public static final String footerICP = "蜀ICP备 xxxxxxx号";
    public static final String footerCopyRight = "@2019 chairchan";
